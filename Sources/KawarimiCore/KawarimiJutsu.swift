...
public enum KawarimiJutsu {
    ...
    public static func generateKawarimiHandlerSource(
        ...
        namingStrategy: KawarimiNamingStrategy = .defensive,
        accessModifier: KawarimiAccessModifier = .public,
    ...
    private static func stderrWarningForFatalErrorStub(operationId: String, detail: String) -> String {
        "Kawarimi warning: KawarimiHandler: using fatalError() stub for operationId \(operationId); \(detail) Set unsupportedHandlerStub: throw in openapi-generator-config.yaml (beside openapi.yaml) to fail the build instead."
    }
